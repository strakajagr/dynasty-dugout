...
# =============================================================================
# RESPONSE MODELS - Two-Line Player Display
# =============================================================================
...
async def get_user_team_id(league_id: str, user_id: str) -> Optional[str]:
    ...
    try:
        ...
        team_query = execute_sql(
            "SELECT team_id FROM league_teams WHERE user_id = :user_id AND is_active = true",
...
async def full_league_data_setup(
    ...
    try:
        ...
        # This is where we need to handle the potential for this to not be a dictionary
